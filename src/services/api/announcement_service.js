...
export const createAnnouncement = async (data) => {
  try {
    const response = await axios.post(
      `${process.env.REACT_APP_BACKEND_BASE_URL}/announcements`,
      data
    );
    return response;
  } catch (error) {
...
export const getAllAnnouncements = async () => {
  try {
    const response = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/announcements`);
    return response;
  } catch (error) {
...
export const updateAnnouncement = async (id, data) => {
  try {
    const response = await axios.put(
      `${process.env.REACT_APP_BACKEND_BASE_URL}/announcements/${id}`,
      data
    );
    return response;
  } catch (error) {
...
export const getAnnouncementsByOrganization = async (id) => {
  try {
    const response = await axios.get(
      `${process.env.REACT_APP_BACKEND_BASE_URL}/organizations/${id}/announcements`
    );
    return response;
  } catch (error) {
    console.log("Error: while getting announcement by id", error);
